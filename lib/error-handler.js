...
export class ErrorHandler {
  ...
  safeStringify(obj) {
    ...
    return JSON.stringify(obj, (key, value) => {
      ...
      // Simplify component stack traces
  ...
  async logError(error, context = {}) {
    ...
    try {
      ...
      // Create a simplified context without React internals
      const safeContext = {};
      if (context.component) {
        safeContext.component = context.component;
      }
      if (context.path) {
        safeContext.path = context.path;
      }
